...
export const CATEGORY_COLOR: Record<CategoryId, { text: string; bg: string; border: string; bar: string }> = {
  ...
  decimals:        { text: 'text-sky-400',      bg: 'bg-sky-500/15',      border: 'border-sky-500/30',      bar: 'bg-sky-500'      },
  negatives:       { text: 'text-red-400',      bg: 'bg-red-500/15',      border: 'border-red-500/30',      bar: 'bg-red-500'      },
  algebra:         { text: 'text-indigo-400',   bg: 'bg-indigo-500/15',   border: 'border-indigo-500/30',   bar: 'bg-indigo-500'   },
  proportionality: { text: 'text-teal-400',     bg: 'bg-teal-500/15',     border: 'border-teal-500/30',     bar: 'bg-teal-500'     },
  geometry:        { text: 'text-lime-400',     bg: 'bg-lime-500/15',     border: 'border-lime-500/30',     bar: 'bg-lime-500'     },
  trigonometry:    { text: 'text-teal-300',     bg: 'bg-teal-500/10',     border: 'border-teal-500/25',     bar: 'bg-teal-600'     },
  ...
  numberTheory:    { text: 'text-sky-300',      bg: 'bg-sky-500/10',      border: 'border-sky-500/25',      bar: 'bg-sky-600'      },
  vedic:           { text: 'text-fuchsia-400',  bg: 'bg-fuchsia-500/10',  border: 'border-fuchsia-500/25',  bar: 'bg-fuchsia-600'  },
  clockTime:       { text: 'text-blue-300',     bg: 'bg-blue-500/10',     border: 'border-blue-500/25',     bar: 'bg-blue-600'     },
...
export const CATEGORY_ORDER: CategoryId[] = [
  ...
  'percentage', 'fractions', 'decimals', 'negatives', 'power', 'squareRoot',
...
export const CATEGORY_SECTIONS: CategorySection[] = [
  ...
  },
  {
    ...
    label: 'Números',
    labelEn: 'Numbers',
    categories: ['percentage', 'fractions', 'decimals', 'negatives', 'power', 'squareRoot'],
  },
  {
    id: 'algebra',
    label: 'Álgebra & Análisis',
    labelEn: 'Algebra & Analysis',
    categories: ['algebra', 'proportionality', 'geometry', 'trigonometry', 'logarithms', 'sequences'],
  },
  {
    id: 'theory',
    label: 'Teoría & Mental',
